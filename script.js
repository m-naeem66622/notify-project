...
function addButtonCheck() {
    // Enable and Disable the the Add Note button 
    if (noteDescription.value == "" || noteTitle.value == "") {
...
function addNote(title, description) {
    ...
    // Creating span Element as tsearchext for Delete button
...
noteDescription.addEventListener("keyup", (e) => {
    if (e.key == "Enter" && e.ctrlKey) {
        localStorage.setItem(noteTitle.value, noteDescription.value);
